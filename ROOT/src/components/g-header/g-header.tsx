...
export const GlobalHeaderByMariePierreLessard = () => {
    return (
        <header className={headerstyle.headerGridByMariePierreLessard}>
            <h1>Fordele og ulemper med <span className={typography.reactBlueByMariePierreLessard} spellCheck="false">React</span>-biblioteket</h1>
            {/* "andreypopp
            on Jun 27, 2014
            Contributor
            ...
            */}
            <p className={headerstyle.bylineByMariePierreLessard}>Marie-Pierre Lessard, den <time dateTime="2026-01-05">5. januar 2026.</time></p>
        </header>
    );
};