            ...
            <div className={mainstyle.gridForOlByMariePierreLessard}>
                <section id="advantages" className={mainstyle.cardWithH2ByMariePierreLessard}>
                    ...
                    <ol className={mainstyle.olLaByMariePierreLessard}>
                        ...
                        <li>Som andre <span spellCheck="false">frontend</span>-biblioteker, gør <span className={typography.reactBlueByMariePierreLessard} spellCheck="false">React</span> en <span spellCheck="false">frontend</span>-udviklers arbejde hurtigt, for eksempel tak til <abbr title="properties">props</abbr> (egenskaber eller "properties" på engelsk).</li>
                    </ol>
                </section>
