        ...
        <main className={mainstyle.proConGridByMariePierreLessard}>
            <section className={mainstyle.card}>
                ...
                <ol className={mainstyle.olByMariePierreLessard}>
                    ...
                    <li><span className={typography.reactBlueByMariePierreLessard} spellCheck="false">React</span> er nemmere at lære end <span className={mainstyle.otherBrandsByMariePierreLessard} spellCheck="false">Angular</span>, for eksempel.</li>
            ...
            <section className={mainstyle.card}>
                ...
                <ol className={mainstyle.olByMariePierreLessard}>
                    <li><span spellCheck="false">jQuery</span> er stadigvæk biblioteket, som er den mest brugt til <span spellCheck="false">frontend</span>-udvikling. (Det er mere populært end <span className={typography.reactBlueByMariePierreLessard} spellCheck="false">React</span>, <span className={mainstyle.otherBrandsByMariePierreLessard} spellCheck="false">Angular</span> og <span className={mainstyle.otherBrandsByMariePierreLessard} spellCheck="false">Vue</span> tilsammen.)</li>
                    <li><span className={mainstyle.otherBrandsByMariePierreLessard} spellCheck="false">Angular</span> har en endnu bedre skalerbarhed end <span className={typography.reactBlueByMariePierreLessard} spellCheck="false">React</span>. Derved bruger store selskaber typisk <span className={mainstyle.otherBrandsByMariePierreLessard} spellCheck="false">Angular</span>, selvom biblioteket er mere besværligt at lære.</li>
                    <li><span className={typography.reactBlueByMariePierreLessard} spellCheck="false">React</span> introducerer snart knækkende ændringer (<span className={globalstyle.foreignLangByMariePierreLessard} spellCheck="false">"breaking changes"</span>) ved at droppe brugen af JS-klasser. Det risikerer at få udviklere til at flygte fra <span className={typography.reactBlueByMariePierreLessard} spellCheck="false">React</span>, da det samme skete med <span className={mainstyle.otherBrandsByMariePierreLessard} spellCheck="false">Angular</span>, da <span className={mainstyle.otherBrandsByMariePierreLessard} spellCheck="false">Angular.js</span> blev til <span className={mainstyle.otherBrandsByMariePierreLessard} spellCheck="false">Angular</span>. (Dengang ændrede biblioteket drastisk sin måde at fungere på.) Med andre ord ender stiafhængigheden (<span className={globalstyle.foreignLangByMariePierreLessard} spellCheck="false">"path dependency"</span>).</li>
